...
namespace FitnessApp.Data.Migrations
{
    ...
    [Migration("20230730145759_AddingColumnForSoftDeleteInProgramUser")]
    partial class AddingColumnForSoftDeleteInProgramUser
    {
            ...
            modelBuilder.Entity("FitnessApp.Data.Models.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTime(2023, 7, 30, 14, 57, 58, 469, DateTimeKind.Utc).AddTicks(7012));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 469, DateTimeKind.Utc).AddTicks(7392),
                            IsActive = false,
            ...
            modelBuilder.Entity("FitnessApp.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7f654c6e-f3f4-46af-b8c9-c7be732b331c"),
                        ...
                        new
                        {
                            Id = new Guid("dd2cef42-6620-4272-8201-9840dcca6bca"),
                        ...
                        new
                        {
                            Id = new Guid("33f6bd69-0c6d-4957-88c7-7274c1ef05e0"),
                        ...
                        new
                        {
                            Id = new Guid("67f3db2f-1b43-4452-b0e8-5318b08185f7"),
            ...
            modelBuilder.Entity("FitnessApp.Data.Models.Program", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1563));
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f02ed6a9-fc39-4d76-9304-ad4fcf535a73"),
                            CategoryId = 4,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1949),
                        ...
                        new
                        {
                            Id = new Guid("202364b7-946b-4338-8d2a-f54bbf16c594"),
                            CategoryId = 4,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1958),
                        ...
                        new
                        {
                            Id = new Guid("26ce4bfd-a719-4d0d-adba-f621e9c52d23"),
                            CategoryId = 4,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1960),
                        ...
                        new
                        {
                            Id = new Guid("633545dc-6c2c-4ac3-a2b4-95db53226015"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1962),
                        ...
                        new
                        {
                            Id = new Guid("0d50143a-86b5-481d-9291-876f2f30ef20"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1980),
                        ...
                        new
                        {
                            Id = new Guid("e30fe41b-cf2b-4f62-a62b-d3c4509ecc33"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1982),
                        ...
                        new
                        {
                            Id = new Guid("4ec63e67-77a9-46dd-bbf9-9460a6491fa1"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1984),
                        ...
                        new
                        {
                            Id = new Guid("5ec75a16-1f75-4fca-8037-d30607533b3f"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1986),
                        ...
                        new
                        {
                            Id = new Guid("1d1ca5d1-fa6f-421f-9ae6-ec27e310e41a"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1989),
                        ...
                        new
                        {
                            Id = new Guid("4d746165-8239-4a46-a900-d98fe7d2cad0"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 7, 30, 14, 57, 58, 470, DateTimeKind.Utc).AddTicks(1991),
