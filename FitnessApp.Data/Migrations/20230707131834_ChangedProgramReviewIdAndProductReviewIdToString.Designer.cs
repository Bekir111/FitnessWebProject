...
namespace FitnessApp.Data.Migrations
{
    ...
    [Migration("20230707131834_ChangedProgramReviewIdAndProductReviewIdToString")]
    partial class ChangedProgramReviewIdAndProductReviewIdToString
    {
            ...
            modelBuilder.Entity("FitnessApp.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("ProgramReviewId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FitnessApp.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cb0c070e-207c-40e6-b53b-b50fa526bfb2"),
                        ...
                        new
                        {
                            Id = new Guid("5910d326-c057-41dc-9880-954d2860e1ec"),
                        ...
                        new
                        {
                            Id = new Guid("2a3a6296-f389-4609-8573-febacaa4c209"),
                        ...
                        new
                        {
                            Id = new Guid("a6ec0eda-2c60-47c5-9ab7-4e28f80fcd3d"),
            ...
            modelBuilder.Entity("FitnessApp.Data.Models.Program", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5654670b-5903-41f1-a1d4-908fe78c0891"),
                            CategoryId = 4,
                            CreatedOn = new DateTime(2023, 7, 7, 13, 18, 34, 143, DateTimeKind.Utc).AddTicks(8493),
                        ...
                        new
                        {
                            Id = new Guid("6c067e01-bd74-490f-b656-04840b26a726"),
                            CategoryId = 4,
                            CreatedOn = new DateTime(2023, 7, 7, 13, 18, 34, 143, DateTimeKind.Utc).AddTicks(8501),
                        ...
                        new
                        {
                            Id = new Guid("5140ae84-4eb2-40d3-abe5-29609a9483a3"),
                            CategoryId = 4,
                            CreatedOn = new DateTime(2023, 7, 7, 13, 18, 34, 143, DateTimeKind.Utc).AddTicks(8533),
                        ...
                        new
                        {
                            Id = new Guid("0734b43b-8f79-4155-9655-51d1a2c1c27c"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 7, 7, 13, 18, 34, 143, DateTimeKind.Utc).AddTicks(8535),
                        ...
                        new
                        {
                            Id = new Guid("c90d798d-e6f3-4cfe-86ab-5a8966a84a8a"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 7, 7, 13, 18, 34, 143, DateTimeKind.Utc).AddTicks(8541),
                        ...
                        new
                        {
                            Id = new Guid("08e2763c-05d6-4e3f-9f2e-22dc2643a675"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 7, 7, 13, 18, 34, 143, DateTimeKind.Utc).AddTicks(8543),
                        ...
                        new
                        {
                            Id = new Guid("ba0ba02e-0ac5-443b-937a-1ffb0d2f28e4"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 7, 7, 13, 18, 34, 143, DateTimeKind.Utc).AddTicks(8546),
                        ...
                        new
                        {
                            Id = new Guid("e344833c-bb8e-41c1-bbec-27bb0d60b67d"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 7, 7, 13, 18, 34, 143, DateTimeKind.Utc).AddTicks(8548),
                        ...
                        new
                        {
                            Id = new Guid("ec26d1e2-5031-4432-aa9e-fbab6398e5fa"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 7, 7, 13, 18, 34, 143, DateTimeKind.Utc).AddTicks(8551),
                        ...
                        new
                        {
                            Id = new Guid("7cb6d5bd-b5c8-43ca-afcf-b01dce26b2c4"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 7, 7, 13, 18, 34, 143, DateTimeKind.Utc).AddTicks(8552),
